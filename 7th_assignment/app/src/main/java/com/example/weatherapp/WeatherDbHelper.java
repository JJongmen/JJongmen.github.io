...
import com.example.weatherapp.WeatherContract.WeatherColumns;
...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE " + WeatherColumns.TABLE_NAME + " (" +
                ...
                WeatherColumns.COLUMN_LONG_DESC + " TEXT NOT NULL, " +
                WeatherColumns.COLUMN_MORNING_TEMP + " REAL NOT NULL, " +
                WeatherColumns.COLUMN_EVENING_TEMP + " REAL NOT NULL, " +
                WeatherColumns.COLUMN_NIGHT_TEMP + " REAL NOT NULL, " +
